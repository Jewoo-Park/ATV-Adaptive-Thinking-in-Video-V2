...
export OUTPUT_DIR="${OUTPUT_DIR:-/workspace/ATV-Adaptive-Thinking-in-Video-V2/outputs/grpo_length_real_9rollout}"
export RUN_NAME="${RUN_NAME:-grpo_length_real_9rollout}"
