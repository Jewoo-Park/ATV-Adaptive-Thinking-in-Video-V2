...
DATA_PATH="${DATA_PATH:-data/generated_dummy_grpo_smoke/perspective/perspective_grpo_dummy.jsonl}"
if [[ ! -s "${DATA_PATH}" ]]; then
...
DEFAULT_MODEL_PATH="${REPO_ROOT}/models/qwen25vl3b_lora_merged_perspective"
...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/tmp_smoke/grpo_perspective_dummy}"
