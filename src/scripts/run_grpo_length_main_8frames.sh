...
export OUTPUT_DIR="${OUTPUT_DIR:-${REPO_ROOT}/outputs/grpo_length_sftbase_strategy_fix_main_8frames}"
export RUN_NAME="${RUN_NAME:-grpo_length_sftbase_strategy_fix_main_8frames}"
...
echo "[MAIN-LENGTH-8F] MAX_STEPS=${MAX_STEPS}, NUM_TRAIN_EPOCHS=${NUM_TRAIN_EPOCHS}"
